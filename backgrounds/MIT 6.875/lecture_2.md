...
<img src = "./lecture_2/figure5.png" width = "500"> <br>
...
<img src = "./lecture_2/figure6.png" width = "500"> <br>
n is input to all these algorithms. 

#####  Computational Indistinguishability (take 2)

<img src = "./lecture_2/figure7.png" width = "500"> <br>
...
PRG answers the following question : Can you take 10 bits of randomness and deterministically output 20 bits of randomness ? <br>
It looks impossible. <br>
However, what we can is generating 20 random bits that <b>look like random bits, not truly random bits</b>. This is psudo-random generators. <br>
<img src = "./lecture_2/figure8.png" width = "500"> <br>

There are two questions about PRG. 
* How to define "seemingly random"?
* Can such a G exist ?

######  Definitions of PRG
There are 3 definitions of strong PRG that are equivalent. <br>
<img src = "./lecture_2/figure9.png" width = "500">

###### Inidstinguishability
<img src = "./lecture_2/figure10.png" width = "500">

$Pr[D(G(Un)) = 1]$ <br>
This means the probability that the distinguisher distinguishes the seemingly random m-bit generated by G, whose input is n-bit, as 1. <br>

$Pr[D(Um) = 1]$ <br>
This means the probability that the distinguisher distinguishes the truly random m-bit as 1. <br>
If the absolute value of these two probabilities are neglible, then it means indistinguishable. <br>
